...
use crate::utils::buffer::extract_tlvs;
...
pub mod factories {
    ...
    use super::{TLV, P2PPayload, SlpPayload, P2PTransportPacket};
...
* 
    ...
    impl P2PTransportPacketFactory {
        ...
        pub fn get_ack(next_sequence_number: u32, next_ack_sequence_number: u32) -> P2PTransportPacket {
            let mut out = P2PTransportPacket::new(next_sequence_number, None);
            out.set_ack(next_ack_sequence_number);
            return out;
        }

        pub fn get_syn_ack(next_sequence_number: u32, next_ack_sequence_number: u32, client_info_tlv: TLV) -> P2PTransportPacket {
            let mut out = P2PTransportPacketFactory::get_ack(next_sequence_number, next_ack_sequence_number);
            out.set_syn(client_info_tlv);
            return out;
        }
    ...
    impl TLVFactory {
        ...
        pub fn get_client_peer_info() -> TLV {
            ...
            let capabilities: u32 = 0x0000010f;
