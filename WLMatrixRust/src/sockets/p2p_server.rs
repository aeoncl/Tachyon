...
use crate::{models::{uuid::UUID, p2p::{pending_packet::PendingPacket, p2p_session::P2PSession}, msn_user::MSNUser}, sockets::{msnp_command::MSNPCommand, msnp2p_command::P2PCommandParser}, P2P_REPO};
                ...
                loop {
                    tokio::select! {
                        bytes_read = reader.read(&mut buffer) => {
                            ...
                            let commands = P2PCommandParser::parse_message(&buffer, do_nonce);
