...
pub mod factories {
    ...
    impl ContactFactory {
        ...
        pub fn get_contact(uuid: &UUID, msn_addr: &String, display_name: &String, contact_type: ContactTypeEnum, deleted: bool) -> ContactType {
            let now = Local::now();
