...
pub(crate) async fn handle_command(
    ...
    match local_switchboard_data.phase {
        ...
        ConnectionPhase::Initializing => {
            let tachyon_client = local_switchboard_data
                .tachyon_client
                .as_ref()
                .ok_or(anyhow!("Client Data should be here by now"))?
                .clone();
            handle_init(
                command,
                command_sender,
        ...
        ConnectionPhase::Ready => {
            let room = local_switchboard_data
                .room
                .as_ref()
                .ok_or(anyhow!("Room should be here by now"))?
                .clone();
            let tachyon_client = local_switchboard_data
                .tachyon_client
                .as_ref()
                ...
                .clone();
            let matrix_client = local_switchboard_data
                .matrix_client
                .as_ref()
                .ok_or(anyhow!("Matrix Client Data should be here by now"))?
                .clone();
            handle_ready(
                command,
                command_sender,
