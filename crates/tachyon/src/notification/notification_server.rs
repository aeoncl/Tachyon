                                ...
                                for command in commands {
                                    ...
                                    match notification_command {
                                        ...
                                        Ok(notification_command) => {
                                            let command_result = handle_command(notification_command, command_sender.clone(), &tachyon_state, &mut local_client_data, client_kill_snd.clone(), &tachyon_state.get_config()).await;
