...
pub async fn handle_url(command: UrlClient, client_data: &mut LocalClientData, tachyon_client: TachyonSessionData, sender: Sender<NotificationServerCommand>) -> Result<(), anyhow::Error>{
