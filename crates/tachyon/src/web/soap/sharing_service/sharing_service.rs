...
pub async fn sharing_service(
    ...
    match soap_action {
        "http://www.msn.com/webservices/AddressBook/FindMembership" => {
            find_membership(
                FindMembershipRequestSoapEnvelope::try_from_xml(&body)?,
                token,
                tachyon_client,
            )
            .await
        ...
        "http://www.msn.com/webservices/AddressBook/AddMember" => {
            add_member(
                AddMemberMessageSoapEnvelope::try_from_xml(&body)?,
                token,
                tachyon_client,
            )
            .await
        ...
        "http://www.msn.com/webservices/AddressBook/DeleteMember" => {
            delete_member(
                DeleteMemberMessageSoapEnvelope::try_from_xml(&body)?,
                token,
                tachyon_client,
            )
            .await
