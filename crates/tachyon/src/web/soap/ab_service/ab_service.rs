...
use std::str::FromStr;
#[debug_handler]
pub async fn address_book_service(
    headers: HeaderMap,
    ...
    match soap_action {
        "http://www.msn.com/webservices/AddressBook/ABFindContactsPaged" => {
            ab_find_contacts_paged(
                AbfindContactsPagedMessageSoapEnvelope::try_from_xml(&body)?,
                token,
                tachyon_client,
            )
            .await
        ...
        "http://www.msn.com/webservices/AddressBook/ABContactAdd" => {
            ab_contact_add(
                AbcontactAddMessageSoapEnvelope::try_from_xml(&body)?,
                token,
        ...
        "http://www.msn.com/webservices/AddressBook/ABContactDelete" => {
            ab_contact_delete(
                AbcontactDeleteMessageSoapEnvelope::try_from_xml(&body)?,
                token,
                tachyon_client.clone(),
                &tachyon_client.users(),
                &soap_action,
        ...
        "http://www.msn.com/webservices/AddressBook/ABContactUpdate" => {
            ab_contact_update(
                AbcontactUpdateMessageSoapEnvelope::try_from_xml(&body)?,
                token,
                tachyon_client.clone(),
                &tachyon_client.users(),
                &soap_action,
...
async fn ab_group_add(
    _request: AbgroupAddMessageSoapEnvelope,
    _token: TicketToken,
) -> Result<Response, ABError> {
    todo!()
}
