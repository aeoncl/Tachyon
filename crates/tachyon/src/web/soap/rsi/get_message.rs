...
pub async fn get_message(request : GetMessageMessageSoapEnvelope, _token: TicketToken, _client: Client, client_data: &mut TachyonSessionData) -> Result<Response, RSIError> {
