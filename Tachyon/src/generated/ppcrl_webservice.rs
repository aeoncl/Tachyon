...
impl ActionHeader {
    ...
    pub fn new(id: String, must_understand: i32, body: String) -> ActionHeader {
        return ActionHeader{ s_ns: String::from("http://www.w3.org/2003/05/soap-envelope"), wsu_ns: String::from("http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd"), wsa_ns:String::from("http://www.w3.org/2005/08/addressing"), id, must_understand, body };
    }
}
...
impl Timestamp
 {
    ...
    pub fn new(id: String, created: String, expires: String) -> Timestamp
     {
        return Timestamp { wsu_ns: String::from("http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd"), id, created, expires };
    }
...
#[derive(Debug, Default, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "psf", namespace= "psf: http://schemas.microsoft.com/Passport/SoapServices/SOAPFault")]
...
impl PassportProperties {
    ...
    pub fn new(puid: String, hex_cid: String, msn_addr: String, server_info: ServerInfo) -> PassportProperties {
        ...
        browser_cookies.push(BrowserCookie { name: String::from("MHW"), url: String::from("http://www.msn.com"), body: String::from("; path=/; domain=.msn.com; expires=Thu, 30-Oct-1980 16:00:00 GMT") });
        browser_cookies.push(BrowserCookie { name: String::from("MH"), url: String::from("http://www.live.com"), body: String::from("MSFT; path=/; domain=.live.com; expires=Wed, 30-Dec-2037 16:00:00 GMT") });
        browser_cookies.push(BrowserCookie { name: String::from("MHW"), url: String::from("http://www.live.com"), body: String::from("; path=/; domain=.live.com; expires=Thu, 30-Oct-1980 16:00:00 GMT") });

        let mut cred_properties = Vec::new();
        ...
        cred_properties.push(CredProperty{ name: String::from("IP"), body: String::from("127.0.0.1") });
        cred_properties.push(CredProperty{ name: String::from("AssociatedForStrongAuth"), body: String::from("0") });

        let mut ext_properties = Vec::new();
        ext_properties.push(ExtProperty{ name: String::from("ANON"), expiry: Some(String::from("Wed, 30-Dec-2037 16:00:00 GMT")), domains: Some(String::from("bing.com;atdmt.com")), ignore_remember_me: Some(false), body: String::from("A=B97FB2EE7DB4CE0D0D5B8107FFFFFFFF&amp;E=1542&amp;W=1") });
        ext_properties.push(ExtProperty{ name: String::from("NAP"), expiry: Some(String::from("Wed, 30-Dec-2037 16:00:00 GMT")), domains: Some(String::from("bing.com;atdmt.com")), ignore_remember_me: Some(false), body: String::from("V=1.9&amp;E=14e8&amp;C=uT838e-8kV7Jbm-HqQel-ETkvE7QSUGh6ywMjZQ9JJyYtNKxtdfCBw&amp;W=1") });
        ext_properties.push(ExtProperty{ name: String::from("LastUsedCredType"), expiry: None, domains: None, ignore_remember_me: None, body: String::from("1") });
        ext_properties.push(ExtProperty{ name: String::from("WebCredType"), expiry: None, domains: None, ignore_remember_me: None, body: String::from("1") });
        ext_properties.push(ExtProperty{ name: String::from("CID"), expiry: None, domains: None, ignore_remember_me: None, body: String::from("%CID%") });


        return PassportProperties{server_version: 1, puid, config_version: String::from("16.000.26889.00"), ui_version: String::from("3.100.2179.0"), mobile_config_version: String::from("16.000.26208.0"), mapp_data_version: 1, authstate: String::from("0x48803"), reqstatus: String::from("0x0"), server_info, cookies: Some(String::new()), browser_cookies: ArrayOfBrowserCookies{browser_cookies}, cred_properties: ArrayOfCredProperty{cred_properties}, ext_properties: ArrayOfExtProperty{ext_properties}, response: None };
...
#[derive(Debug, Default, YaSerialize, YaDeserialize)]
#[yaserde(prefix = "wst", namespace= "S: http://www.w3.org/2003/05/soap-envelope", 
...
mod tests {
    ...
    use crate::{generated::ppcrl_webservice::{ActionHeader, AppliesTo, EndpointReference, Lifetime, PassportProperties, Reference, RequestedAttachedReference, RequestedProofToken, RequestedSecurityToken, RequestSecurityTokenResponse, RequestSecurityTokenResponseCollection, RST2ResponseMessageBody, RST2ResponseMessageHeader, RST2ResponseMessageSoapEnvelope, SecurityHeader, SecurityTokenReference, ServerInfo, Timestamp}, models::uuid::UUID};

    use super::{CipherData, EncryptedData, EncryptionMethod, factories::RST2ResponseFactory, KeyInfo, RST2RequestMessageSoapEnvelope};
