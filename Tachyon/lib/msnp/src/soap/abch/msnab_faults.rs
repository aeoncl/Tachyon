...
pub mod factory {
	use super::super::msnab_faults::{FaultBody, FaultResponse, SoapFault};
	...
	pub mod soap_fault {
		...
		use super::super::super::msnab_faults::{FaultAdditionalDetails, FaultDetail, FaultErrorCode, SoapFault};
...
mod tests {
	...
	use crate::shared::models::uuid::Uuid;
	use crate::soap::abch::msnab_faults;

	#[test]
	fn test_serialize_fault_response() {

		let response = msnab_faults::factory::get_fault_response(msnab_faults::factory::soap_fault::get_contact_already_exists("http://www.msn.com/webservices/AddressBook/SoapAction".into(), &Uuid::from_seed("hey")));
